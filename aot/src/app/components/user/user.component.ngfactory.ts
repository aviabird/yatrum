...
class View_UserComponent_Host0 extends import1.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    if (this._UserComponent_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
...
const styles_UserComponent:any[] = [import9.styles];
...
export class View_UserComponent0 extends import1.AppView<import0.UserComponent> {
  ...
  _text_1:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_UserComponent0,renderType_UserComponent,import5.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import6.ChangeDetectorStatus.CheckOnce);
  }
  createInternal(rootSelector:string):import7.ComponentRef<any> {
