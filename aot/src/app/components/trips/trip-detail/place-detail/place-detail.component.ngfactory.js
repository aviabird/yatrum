...
var View_PlaceDetailComponent_Host0 = (function (_super) {
    ...
    View_PlaceDetailComponent_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        if (this._PlaceDetailComponent_0_3.ngDoCheck(this, this._el_0, throwOnChange)) {
...
export var View_PlaceDetailComponent0 = (function (_super) {
    ...
    function View_PlaceDetailComponent0(viewUtils, parentView, parentIndex, parentElement) {
        _super.call(this, View_PlaceDetailComponent0, renderType_PlaceDetailComponent, import6.ViewType.COMPONENT, viewUtils, parentView, parentIndex, parentElement, import7.ChangeDetectorStatus.CheckOnce);
    ...
    View_PlaceDetailComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_1 = this.renderer.createText(this._el_0, '\n  ', null);
        this._el_2 = import3.createRenderElement(this.renderer, this._el_0, 'div', new import3.InlineArray2(2, 'class', 'two wide column'), null);
        ...
        this._el_6 = import3.createRenderElement(this.renderer, this._el_2, 'div', new import3.InlineArray2(2, 'class', 'vertical-line'), null);
        this._text_7 = this.renderer.createText(this._el_6, '\n    ', null);
        this._text_8 = this.renderer.createText(this._el_2, '\n  ', null);
        this._text_9 = this.renderer.createText(this._el_0, '\n  ', null);
        this._el_10 = import3.createRenderElement(this.renderer, this._el_0, 'div', new import3.InlineArray2(2, 'class', 'fourteen wide column'), null);
        this._text_11 = this.renderer.createText(this._el_10, '\n    ', null);
        this._el_12 = import3.createRenderElement(this.renderer, this._el_10, 'div', new import3.InlineArray2(2, 'class', 'ui card activity'), null);
        this._text_13 = this.renderer.createText(this._el_12, '\n      ', null);
        this._el_14 = import3.createRenderElement(this.renderer, this._el_12, 'div', new import3.InlineArray2(2, 'class', 'header'), null);
        this._text_15 = this.renderer.createText(this._el_14, '\n        ', null);
        this._el_16 = import3.createRenderElement(this.renderer, this._el_14, 'div', new import3.InlineArray2(2, 'class', 'place-name'), null);
        this._text_17 = this.renderer.createText(this._el_16, '', null);
        this._el_18 = import3.createRenderElement(this.renderer, this._el_16, 'i', new import3.InlineArray2(2, 'class', 'marker big icon'), null);
        this._text_19 = this.renderer.createText(this._el_16, '\n        ', null);
        this._text_20 = this.renderer.createText(this._el_14, '\n        ', null);
        this._el_21 = import3.createRenderElement(this.renderer, this._el_14, 'div', new import3.InlineArray2(2, 'class', 'place-date'), null);
        this._text_22 = this.renderer.createText(this._el_21, '\n          ', null);
        this._el_23 = import3.createRenderElement(this.renderer, this._el_21, 'i', new import3.InlineArray2(2, 'class', 'checked calendar big icon'), null);
        ...
        this._el_27 = import3.createRenderElement(this.renderer, this._el_12, 'div', new import3.InlineArray2(2, 'class', 'place-review'), null);
        this._text_28 = this.renderer.createText(this._el_27, '', null);
        this._text_29 = this.renderer.createText(this._el_12, '\n      ', null);
        this._el_30 = import3.createRenderElement(this.renderer, this._el_12, 'div', new import3.InlineArray2(2, 'class', 'place-images'), null);
    ...
    View_PlaceDetailComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_32_0_0 = this.context.place.pictures;
        ...
        var currVal_41 = import3.inlineInterpolate(1, '\n        ', this.context.place.review, '\n      ');
    ...
    View_PlaceDetailComponent0.prototype.createEmbeddedViewInternal = function (nodeIndex) {
        if ((nodeIndex == 32)) {
            return new View_PlaceDetailComponent1(this.viewUtils, this, 32, this._anchor_32, this._vc_32);
        }
        return null;
    };
