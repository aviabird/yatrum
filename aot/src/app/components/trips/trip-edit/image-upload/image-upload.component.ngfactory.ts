...
class View_ImageUploadComponent_Host0 extends import1.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    if (this._ImageUploadComponent_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
...
const styles_ImageUploadComponent:any[] = [import10.styles];
...
export class View_ImageUploadComponent0 extends import1.AppView<import0.ImageUploadComponent> {
  _viewQuery_fileInput_0:import11.QueryList<any>;
  _el_0:any;
  _text_1:any;
  _el_2:any;
  _text_3:any;
  ...
  /*private*/ _expr_7:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_ImageUploadComponent0,renderType_ImageUploadComponent,import5.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import6.ChangeDetectorStatus.CheckOnce);
    this._expr_7 = import12.UNINITIALIZED;
  }
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    const parentRenderNode:any = this.renderer.createViewRoot(this.parentElement);
    this._viewQuery_fileInput_0 = new import11.QueryList<any>();
    ...
    this._el_2 = import3.createRenderElement(this.renderer,parentRenderNode,'span',new import3.InlineArray2(2,'class','ui card add-photo'),(null as any));
    this._text_3 = this.renderer.createText(this._el_2,'\n	',(null as any));
    this._el_4 = import3.createRenderElement(this.renderer,this._el_2,'i',new import3.InlineArray2(2,'class','add circle icon'),(null as any));
