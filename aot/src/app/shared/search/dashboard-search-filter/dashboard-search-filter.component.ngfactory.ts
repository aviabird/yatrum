...
import * as import0 from '../../../../../../src/app/shared/search/dashboard-search-filter/dashboard-search-filter.component';
...
class View_DashboardSearchFilterComponent_Host0 extends import2.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    if (this._DashboardSearchFilterComponent_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
...
export class View_DashboardSearchFilterComponent0 extends import2.AppView<import0.DashboardSearchFilterComponent> {
  ...
  _text_11:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_DashboardSearchFilterComponent0,renderType_DashboardSearchFilterComponent,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckOnce);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
