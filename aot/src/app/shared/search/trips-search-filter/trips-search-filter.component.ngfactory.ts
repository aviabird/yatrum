...
export class Wrapper_TripsSearchFilterComponent {
  /*private*/ _eventHandler:Function;
  context:import0.TripsSearchFilterComponent;
...
var renderType_TripsSearchFilterComponent_Host:import4.RenderComponentType = import3.createRenderComponentType('',0,import5.ViewEncapsulation.None,([] as any[]),{});
class View_TripsSearchFilterComponent_Host0 extends import2.AppView<any> {
  _el_0:any;
  compView_0:import2.AppView<import0.TripsSearchFilterComponent>;
  _TripsSearchFilterComponent_0_3:Wrapper_TripsSearchFilterComponent;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_TripsSearchFilterComponent_Host0,renderType_TripsSearchFilterComponent_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer,'tr-trips-search-filter',import3.EMPTY_INLINE_ARRAY,rootSelector,(null as any));
    ...
    return new import8.ComponentRef_<any>(0,this,this._el_0,this._TripsSearchFilterComponent_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.TripsSearchFilterComponent) && (0 === requestNodeIndex))) { return this._TripsSearchFilterComponent_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    if (this._TripsSearchFilterComponent_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
...
export const TripsSearchFilterComponentNgFactory:import8.ComponentFactory<import0.TripsSearchFilterComponent> = new import8.ComponentFactory<import0.TripsSearchFilterComponent>('tr-trips-search-filter',View_TripsSearchFilterComponent_Host0,import0.TripsSearchFilterComponent);
const styles_TripsSearchFilterComponent:any[] = [import9.styles];
var renderType_TripsSearchFilterComponent:import4.RenderComponentType = import3.createRenderComponentType('',0,import5.ViewEncapsulation.Emulated,styles_TripsSearchFilterComponent,{});
export class View_TripsSearchFilterComponent0 extends import2.AppView<import0.TripsSearchFilterComponent> {
  _el_0:any;
  _text_1:any;
  _el_2:any;
  _text_3:any;
  ...
  _text_11:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_TripsSearchFilterComponent0,renderType_TripsSearchFilterComponent,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckOnce);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
